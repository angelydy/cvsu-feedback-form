...
if(isset($_POST['submit'])) {
    ...
    $sql="update `user` set id=$id, honorific='$honorific', firstname='$firstname',
            ...
            <table class="additional_info_area">
                ...
                <center>
                    <td style="display: inline-block; padding: 0 .5em 0 .5em;">
                      <p style="text-align: left;"> &nbspHonorific <br>
                        <input type="text" name="honorific" autocomplete="off" value="<?php echo $honorific ?>" />
                      </p>
                    </td>
                    <td style="display: inline-block; padding: 0 .5em 0 .5em;">
                ...
                <center>
                    ...
                    <td style="display: inline-block; padding: 0 .5em 0 .5em;">
                      <p style="text-align: left;"> &nbspPassword <br>
                          <input type="password" name="password" autocomplete="off" value="<?php echo $password ?>" /><br>
                      </p>
                    </td>
                </center>
              </tr>
              <tr align="center" valign="center">
                <center>
                  ...
                  <input type="submit" value="Change" name="submit" onclick="return confirm('Edit this account?')" class="update-btn2" style="margin: 0 .75em 0 .75em;"/>
                  <input type="button" value="Cancel" onclick="window.location.href='manage-account.php'" class="cancel-btn2" style="margin: 0 .75em 0 .75em;"/>
                  </td>
                </center>
              </tr>
            </table>
