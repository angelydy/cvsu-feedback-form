...
<head>
  ...
  <title>CvSU OSFS - Procurement Office</title>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: black; font-family: 'Poppins'; height:8.5%;" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-weight: 700;">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="#">&nbsp&nbsp&nbspProcurement Office Admin Panel&nbsp&nbsp</a>
        </li>
      </ul>
    </div>
  </nav>
    ...
    require 'config.php';
      if (isset($_SESSION['login_user'])) {
        ...
        $result = mysqli_query($con,"SELECT * FROM user");
          echo "<center><h1 style='margin-top:10%; margin-bottom:2.5%; font-size: 1.5em; font-weight:800;'>Manage Accounts</h1></center>";
          ...
          while($row = mysqli_fetch_array($result)) {
            ...
            echo "<td align='center' valign='center'> 
                    <a href='edit-account.php?editid=".$id."'>
                    ...
                    <a href='delete-account.php?deleteaccid=".$id."' class='confirmation' >
